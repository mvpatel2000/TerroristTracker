...
test_image_list, test_label_list = read_labeled_image_list("eval1.txt")
...
image_batch, label_batch = tf.train.batch([train_image, train_label],batch_size=17178) #13026
...
for i in range(1):
  ...
  np.savetxt('frop1.txt',output.eval(feed_dict={x:test_imgs,y_:test_lbls}))
