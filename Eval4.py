...
test_image_list, test_label_list = read_labeled_image_list("eval4.txt")
...
image_batch, label_batch = tf.train.batch([train_image, train_label],batch_size=17178) #4494
...
for i in range(1):
  ...
  np.savetxt('frop4.txt',output.eval(feed_dict={x:test_imgs,y_:test_lbls}))
